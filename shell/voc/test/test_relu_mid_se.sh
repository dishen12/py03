...
weight_file=./weights/VOC/relu_mid_se_5_inter123
eval_folder=./eval/VOC/relu_mid_se_5_inter123
for((i=10;i<=400;i+=5));do
    ...
    echo $weight
    echo $save_folder
    python test_RFB.py -d VOC -v relu_mid_se -s 512 -r "9,5,2,1" -m  $weight --save_folder=$save_folder
done
