...
weight_file=./weights/coco/relu_mid_512/
eval_folder=./eval/coco/relu_mid_minval_justfortest/
for((i=60;i<=400;i+=5));do
    ...
    echo $weight
    echo $save_folder
    python test_RFB.py -d COCO -v relu_mid -s 512 -r "9,5,2,1" -m  $weight --save_folder=$save_folder
done
