...
eval_folder=./eval/coco/relu_mid_mutil_rate_minval_512
for((i=200;i<=400;i+=5));do
    ...
    echo $weight
    echo $save_folder
    python test_RFB.py -d COCO -v relu_mid_mutil_rate -s 512 -r "9,5,2,1,6,3,2,1,9,5,2,1" -m  $weight --save_folder=$save_folder
done
