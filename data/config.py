...
VOCroot = os.path.join("/nfs/project/VOC/VOCdevkit/", "VOCdevkit/") #ddir # path to VOCdevkit root dir
COCOroot = os.path.join("/nfs/project", "coco/")
D2CITYroot = "/nfs/project/d2_city/public_data/ssd/"
